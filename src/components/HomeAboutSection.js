...
export default function HomeAboutSection() {
  return (
    <section className="w-full bg-white py-12 px-4 md:px-0 overflow-x-hidden">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10 md:gap-16">
        ...
        >
          ...
          <Link href="/about" className="inline-block bg-accent text-white font-semibold px-6 py-2 rounded shadow hover:bg-primary transition-colors duration-200 mt-2 mx-auto">See More</Link>
        </motion.div>
        ...
        >
          <img 
            ...
            className="w-full max-w-full h-48 sm:h-72 md:h-96 object-cover rounded-xl shadow-lg border-4 border-white" 
